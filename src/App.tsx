...
const App = () => {
  // Initialize MobX stores and apply theme on mount
  useEffect(() => {
    // This is handled by the UIStore constructor in a real app
    // This is just a fallback in case localStorage isn't available
